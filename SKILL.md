...
### NEU in Version 3.0: Lagerlayout & Artikel-Stammdaten

Version 3.0 erweitert den Skill um vollständige Lagerlayout-Dokumentation:

- **74 Artikel mit Storage Compartment IDs** – Alle 3 Orders (2904/2905/2906) mit Lagerorten (R<Komplex>.<Regal>.<Ebene>.<Fach>)
- **Lagerlayout (Fraunhofer IML Picking Lab)** – 12,76m × 17,35m, 8 Regalkomplexe, 5 Gassen
- **Gewichtsklassen dokumentiert** – Small [S] (≤50g), Medium [M] (50-800g), Large [L] (>800g)
- **9 funktionale Hauptbereiche** – Office, Cart Area, Base, Packing Area, etc. mit DaRa-Labels
- **MTM-1 Codes vollständig** – 7 Grundbewegungen (R, G, M, P, RL, B, W) mit TMU-Werten
- **Regalfach-Maße präzise** – 95,5 × 39,5 × 21 cm (Standard), 104cm (Textilien), 41cm (schwere Güter)

### NEU in Version 2.5: Label-Aktivitätsanalyse & CC09-Integration
...
**Skill-Stand:** 14.01.2026 (Version 3.0)
...
10. **🆕 Lagerlayout & Artikel** (NEU in v3.0)
...
## Lagerlayout & Artikel-Stammdaten (NEU in v3.0)
...
| Gasse | Regalkomplexe | DaRa-Labels (CC11/CC12) | Artikel-Typen |
|-------|---------------|-------------------------|---------------|
| **Aisle 1** | R1 | CL172/CL199 | Kleinteile (Muttern, Schrauben) |
| **Aisle 2** | R2, R3 | CL173/CL200 | Textilien (Jacken, Handschuhe) |
| **Aisle 3** | R4, R5 | CL174/CL201 | Werkzeuge (Bits, Drohnen) |
| **Aisle 4** | R6, R7 | CL175/CL202 | Schwere Güter (Handbeile, Palmenerde) |
| **Aisle 5** | R8 | CL176/CL203 | Abschlussbereich (Handbeile, Getränke) |

**Storage Compartment ID Logik:**
- Format: `R<Komplex>.<Regal>.<Ebene>.<Fach>`
- Beispiel: R1.2.7.A = Komplex 1, Regal 2, Ebene 7, Fach A
- **Ebene 1 = Bodenebene** (bestätigt durch Artikel wie Palmenerde R7.3.1.A)
...
**Vollständige Artikel-Liste:** Siehe `knowledge/core/articles_inventory.md`  
**Lagerlayout-Details:** Siehe `knowledge/core/warehouse_layout.md`
...
│   │   ├── labels_207.md                       # Alle 12 Kategorien + 207 Labels
│   │   ├── recognition_algorithm_v2.6.md       # Vollständiger Algorithmus (Score + Hybrid-Logic)
│   │   ├── validation_rules.md                 # Alle Validierungsregeln
│   │   ├── articles_inventory.md               # 🆕 74 Artikel mit Lagerorten (Orders 2904/2905/2906)
│   │   └── warehouse_layout.md                 # 🆕 Lagerlayout (5 Gassen, 8 Regalkomplexe)
│   ├── processes/
│   │   ├── process_hierarchy.md                # BPMN-Logik CC08-CC10
│   │   ├── refa_analytics.md                   # REFA-Zeitarten, Formeln
│   │   └── mtm_codes.md                        # 🆕 MTM-1 Codes (R, G, M, P, RL, B, W) + TMU-Werte
│   ├── auxiliary/
...
### 🧭 Navigationslogik (aktualisiert für v3.0)

**Schritt 1: Frage klassifizieren & Datei laden**

```python
# 1. REFA / Arbeitswissenschaft / Zeiten / MTM

if "REFA" or "Zeitart" or "Erholung" or "Kalkulation" or "t_MH" or "t_R" or "MTM" or "TMU" in query:
    view("knowledge/processes/refa_analytics.md")
    if "MTM" or "Reach" or "Grasp" or "Move" or "Bend" or "Walk" in query:
        view("knowledge/processes/mtm_codes.md")

# 2. Lagerlayout / Gassen / Fachmaße / Bereiche

elif "Lager" or "Gasse" or "Aisle" or "Regalkomplex" or "Fach" or "Bereich" or "Office" or "Cart Area" in query:
    view("knowledge/core/warehouse_layout.md")

# 3. Artikel / Lagerort / Storage ID / Order / Gewicht

elif "Artikel" or "R1." or "R2." or "Storage" or "Compartment" or "Order 2904" or "Order 2905" or "Order 2906" or "Gewicht" or "Small" or "Medium" or "Large" in query:
    view("knowledge/core/articles_inventory.md")

# 4. Validierung / Logik / Regeln / Konsistenz

elif "Validierung" or "Logik" or "Konsistenz" or "Regel" or "Darf ich" or "gültig" in query:
    view("knowledge/core/validation_rules.md")

# 5. Label-Lookup / Definitionen

elif "CC" + number or "CL" + number or "Was ist" + Labelname in query:
    view("knowledge/core/labels_207.md")

# 6. Prozess-Ablauf / BPMN
...
- "Laut articles_inventory.md ist Palmenerde in R7.3.1.A gelagert"
...
- Lagerlayout-Dokumentation (warehouse_layout.md, articles_inventory.md)
- Validierungslogik (validation_rules.md)
- Szenarioerkennung (ground_truth_central.md, recognition_algorithm_v2.6.md)
...
| 2.3 | 31.12.2025 | Flexible Szenarioerkennung ohne harte Grenzen, S8 Order-Set korrigiert |
| 2.6 | 07.01.2026 | Hybrid-Identification-Logic für S1-S6, Evidence-Based Scoring |
| **3.0** | **14.01.2026** | **Lagerlayout vollständig (warehouse_layout.md), 74 Artikel mit Lagerorten (articles_inventory.md), MTM-1 Codes (mtm_codes.md), Gewichtsklassen, 9 funktionale Bereiche, Regalfach-Maße** |
