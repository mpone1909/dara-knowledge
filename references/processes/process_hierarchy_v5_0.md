...
**Beispiel:** Retrieval (CL110) → Storage (CL111) bei Lagerbestands-Umschlag

---

### 2. Übergänge zwischen Mid-Level-Prozessen

Mid-Level-Prozesse wechseln **häufiger** als High-Level (ca. alle 10-30 Sekunden). Typische Sequenzen:
...
- BPMN-Grafik → Siehe [dataset_core_v5.0.md](../auxiliary/dataset_core_v5.0.md)
- Label-Definitionen → Siehe [labels_207_v5.0.md](../core/labels_207_v5.0.md)
- Szenario-Details → Siehe [ground_truth_central_v5.0.md](../core/ground_truth_central_v5.0.md)
- Chunking-Logik → Siehe [chunking_v5.0.md](../auxiliary/chunking_v5.0.md)
...
Die Prozessabfolgen müssen konsistent mit den **Validierungsregeln** sein. Siehe `core_validation_rules_v5_0.md` für:
- Master-Slave-Abhängigkeiten zwischen Prozessebenen (CC08 → CC09 → CC10)
- Sequenzvalidierung: Welche Prozesswechsel sind zulässig?
- Fehlerszenarien bei ungültigen Prozessübergängen
