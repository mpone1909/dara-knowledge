...
**Formel:**
```
t_MH = Î£(R + G + M + P + RL + B) für alle Picking/Storing Aktivitäten
t_MN = Î£(W) für alle Travel Time Aktivitäten
```
...
- DaRa-Label → MTM-Code Mapping
- Zeitberechnung für Bewegungssequenzen

**Verwandte Dateien:**
- [refa_analytics_v5.0.md](refa_analytics_v5.0.md) – REFA-Zeitarten und Erholungszeit
- [labels_207_v5.0.md](../core/labels_207_v5.0.md) – Vollständige Label-Definitionen
- [articles_inventory_v5.0.md](../core/articles_inventory_v5.0.md) – Artikel-Gewichtsklassen
