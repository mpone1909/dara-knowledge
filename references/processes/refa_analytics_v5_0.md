...
- Label-Definitionen → [labels_207_v5.0.md](../core/labels_207_v5.0.md)
- Chunking-Grundlagen → [chunking_v5.0.md](../auxiliary/chunking_v5.0.md)
- Prozess-Hierarchie → [process_hierarchy_v5.0.md](process_hierarchy_v5.0.md)
- Artikel-Gewichtsklassen → [articles_inventory_v5.0.md](../core/articles_inventory_v5.0.md)
...
**Vollständige Dokumentation:** `knowledge/processes/mtm_codes_v5.0.md`
...
**Siehe:** `mtm_codes_v5.0.md` für vollständige TMU-Tabellen und Berechnungsbeispiele
