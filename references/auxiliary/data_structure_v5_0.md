...
1.  **Erste Zeile:** Vollständige Liste der zugehörigen Labelnamen (Header).
...
* Inhaltliche Label-Definitionen → Siehe [core_labels_207_v5_0.md](../core/core_labels_207_v5_0.md)
* BPMN-Prozesslogik → Siehe [auxiliary_dataset_core_v5_0.md](./auxiliary_dataset_core_v5_0.md)
* Probanden-Demographie → Siehe [auxiliary_dataset_core_v5_0.md](./auxiliary_dataset_core_v5_0.md)
...
**Status:** Finalisiert ✅  
**Bemerkung:** Inhaltlich unverändert. Nur Referenzen auf _v5_0-Dateien aktualisiert.
