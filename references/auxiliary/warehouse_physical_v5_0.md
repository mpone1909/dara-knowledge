...
Die Zonenaufteilung ist **farblich codiert** und durch **Bodenmarkierungen** (Klebeband und Absperrstände) definiert.
...
- **Physische Abgrenzung:** Absperrstände mit Gurtbändern
...
## 6. Regalsystem & Regelfächer (Compartments)
...
**Für Probanden-Information:** Siehe [auxiliary_dataset_core_v5_0.md](./auxiliary_dataset_core_v5_0.md)

**Für Session-Struktur:** Siehe [auxiliary_data_structure_v5_0.md](./auxiliary_data_structure_v5_0.md)

**Für Klassendefinitionen:** Siehe [core_labels_207_v5_0.md](../core/core_labels_207_v5_0.md)

**Für Validierungsregeln:** Siehe core_validation_rules.md (noch nicht v5.0)
...
**Status:** Finalisiert ✅  
**Bemerkung:** Inhaltlich unverändert gegenüber v3.0. Nur Metadaten und Referenzen auf _v5_0-Dateien aktualisiert.
