...
- **S4** – Standard Storage
- **S5** – Variant Storage
- **S8** – Multi-Order Storage Perfect Run

### Packaging/Sorting-Szenario
- **S6** – Packaging and Sorting
...
### 3. Prozesslogik von Packaging/Sorting (S6)

Packaging/Sorting besitzt eine eigene, ausgeprägte Prozessstruktur:

- Tätigkeiten wie Opening, Filling, Labelling, Sealing,
- intensive Tool-Nutzung (Knife, Tape Dispenser, Bubble Wrap etc.),
- stationäre Arbeit an Tables und Packing Areas,
- sequentielle Produktvorbereitung und Sortierung.

Diese Prozesse unterscheiden sich klar von Retrieval/Storage und bilden eine separate prozedurale Kategorie.
...
| Szenario | Typ | High-Level | Charakteristik |
|----------|-----|------------|----------------|
| S1 | Retrieval | CL110 | Standard-Kommissionierung |
| S2 | Retrieval | CL110 | Variante der Kommissionierung |
| S3 | Retrieval | CL110 | Fehlerhafte Kommissionierung |
| S4 | Storage | CL111 | Standard-Einlagerung |
| S5 | Storage | CL111 | Variante der Einlagerung |
| S6 | Packaging/Sorting | - | Verpackung und Sortierung |
| S7 | Retrieval | CL110 | **Multi-Order Perfect Run** |
| S8 | Storage | CL111 | **Multi-Order Perfect Run** |
